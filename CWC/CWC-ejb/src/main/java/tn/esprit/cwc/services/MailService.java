...
public class MailService {
	    ...
	    private static final String USER = "ameni.meddeb@esprit.tn";     // Must be valid user in d.umn.edu domain, e.g. "smit0012"
	    private static final String PASSWORD = "26678826"; // Must be valid password for smit0012
	    private static final String FROM = "Commun Transport <ameni.meddeb@esprit.tn>";     // Full info for user, e.g. "Fred Smith <smit0012@d.umn.edu>"
	}
